...
type ColumnField struct {
	...
	CamelCaseName       string   `json:"camel_case_name" description:"Derived camel-case version of field name, with underscores stripped out. (ex. IDField1)"`
	StructName          string   `json:"struct_name" description:"Derived snake-case version of field name, with all letters lowercase. (ex. id_field_1)"`
	Optional            bool     `json:"optional" description:"Whether a value must be specified for the field."`
...
type ColumnConstraints struct {
	...
	UniqueRequired    bool          `json:"unique_required" description:"If true, each value for the associated column must be unique for the user."`
